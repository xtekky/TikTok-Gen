...
if __name__ == '__main__':
    ...
    __json = {
        ...
        'htc6j8njvn-d': 'ABaChIjBTKGNgUGAQZIQhISi0eIApJmhDgDbri32QIsiPQAAAABuAWLeAAmVfDiR7OpoMtvN1rwA8pE',# idk
        'htc6j8njvn-f': 'A5JgcYSCAQAAN1Eyh1m1OEcpWE3AxsI5A_xXyMttxQWqMNctEkI4wATINOHDAbknjb-uci7ywH8AAEB3AAAAAA==', # init("(\s*)"
        'htc6j8njvn-z': 'q',
    }
